...
import { parseDay, type AbsenceAction, type AbsenceStatus, type LoadBand } from '../services'
import type { AbsenceType } from '../services/absences'
import type { HrDept, PayGrade, SkillKey, SkillLevel } from '../services/employees'
