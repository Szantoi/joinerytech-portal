    ...
    <div className="min-h-screen flex bg-stone-50">
      ...
      <aside className="hidden lg:flex flex-col w-[44%] xl:w-[48%] relative overflow-hidden bg-stone-900 text-stone-100">
        ...
        <div className="relative px-12 pb-10 flex items-center justify-between text-[11px] text-stone-400">
          ...
          <div className="flex items-center gap-4">
            <span className="hover:text-stone-200 cursor-pointer">Adatvédelem</span>
            <span className="hover:text-stone-200 cursor-pointer">ÁSZF</span>
            <span className="hover:text-stone-200 cursor-pointer">Súgó</span>
          </div>
        </div>
      </aside>
      ...
      <main className="flex-1 flex flex-col">
          ...
          <div className="w-full max-w-[400px]">
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22 12.2c0-.7-.1-1.4-.2-2H12v3.8h5.6c-.2 1.3-1 2.4-2.2 3.1v2.6h3.6c2.1-1.9 3-4.7 3-7.5z" />
                      <path fill="#34A853" d="M12 22c2.9 0 5.4-1 7.2-2.6l-3.6-2.6c-1 .7-2.3 1.1-3.6 1.1-2.8 0-5.1-1.9-5.9-4.4H2.4v2.7C4.2 19.8 7.8 22 12 22z" />
                      <path fill="#FBBC05" d="M6.1 13.5c-.2-.6-.3-1.3-.3-2 0-.7.1-1.4.3-2V6.8H2.4C1.5 8.4 1 10.1 1 12s.5 3.6 1.4 5.2l3.7-2.7z" />
                      <path fill="#EA4335" d="M12 5.6c1.6 0 3 .6 4.1 1.6l3.1-3.1C17.4 2.4 14.9 1.4 12 1.4 7.8 1.4 4.2 3.6 2.4 6.8l3.7 2.7c.8-2.5 3.1-3.9 5.9-3.9z" />
                    </svg>
                    Google
                  </button>
                  <button
            ...
            {mode === 'forgot' && (
              <div>
                ...
                {forgotSent ? (
                  <div className="p-4 rounded-lg bg-teal-50 border border-teal-200 text-[12.5px] text-teal-800 mb-4">
                    Visszaállító link elküldve! Ellenőrizd az email-fiókodat.
                  </div>
                ) : (
                  <>
                    <label className="block mb-4">
        ...
        <footer className="px-5 py-4 border-t border-stone-200 text-[11px] text-stone-500 flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-4">
            <span className="hover:text-stone-700 cursor-pointer">Súgó</span>
            <span className="hover:text-stone-700 cursor-pointer">Állapotoldal</span>
            <span className="hover:text-stone-700 cursor-pointer">Kapcsolat</span>
          </div>
        </footer>
      </main>
    </div>
