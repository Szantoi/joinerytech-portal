...
export type WorldKey = 'production' | 'sales' | 'design' | 'warehouse' | 'shopfloor' | 'settings' | 'crm' | 'finance' | 'projects' | 'logistics' | 'mfgprep' | 'supervisor' | 'masterdata' | 'trade' | 'interior' | 'maintenance' | 'quality' | 'ehs' | 'attendance' | 'tasks' | 'docs' | 'ai' | 'execbi'
