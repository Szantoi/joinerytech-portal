...
import { Button, DataTable, QueryGate, StatusPill, type DataTableColumn } from '@spaceos/portal-ui'
import { useAdjustments, useDeleteAdjustment, useProjects, type CostAdjustment } from '../services'
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-7 md:py-6">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h2 className="text-[20px] font-semibold tracking-tight text-ink md:text-[24px]">Utókalkuláció</h2>
