...
import { Button, QueryGate, StatusPill } from '@spaceos/portal-ui'
import { useTasks, useCompleteTask, computeTaskSla, type CrmTask } from '../services'
  ...
  return (
    <div className="mx-auto max-w-[900px] px-4 py-5 md:px-7 md:py-6">
      <div className="mb-4 flex flex-wrap items-end justify-between gap-2">
        <div>
          <h2 className="text-[20px] font-semibold tracking-tight text-ink md:text-[24px]">Feladatok</h2>
