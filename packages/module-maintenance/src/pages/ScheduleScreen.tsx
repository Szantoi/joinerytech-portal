...
import { QueryGate, STATUS_TONES } from '@spaceos/portal-ui'
import {
  SCHEDULE_WINDOW_DAYS, scheduleWindow, todayIso, useWorkOrders,
} from '../services'
import type { WorkOrder, WorkOrderType } from '../services/workOrders'
import {
...
export function ScheduleScreen() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-4 py-5 md:px-7 md:py-6">
      <div className="mb-4">
        <h2 className="text-[20px] font-semibold tracking-tight text-ink md:text-[24px]">Ütemterv</h2>
