...
import { AuthContext, type AuthContextValue } from '@spaceos/portal-core'
import { ehsApiHandlers, getEhsDb, resetEhsDb } from '@spaceos/module-ehs/mocks'

// A globális test-setup a @spaceos/portal-core useAuth-ját user:null-ra mockolja
// (HEAD-hű viselkedés a shell-teszteknek). Ez a fájl viszont a VALÓDI useAuth-ot
// akarja a saját AuthContext.Provider-ével (reporterId = user.profile.sub) —
// fájl-szinten visszaállítjuk az eredeti modult.
vi.mock('@spaceos/portal-core', async (importOriginal) => await importOriginal())

const mockAuthValue: AuthContextValue = {
  user: { profile: { sub: '11111111-1111-4111-8111-111111111111' } } as unknown as AuthContextValue['user'],
