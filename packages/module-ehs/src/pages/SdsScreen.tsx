...
import { DataTable, QueryGate, StatusPill, type DataTableColumn } from '@spaceos/portal-ui'
import {
...
export function SdsScreen() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-5 md:px-7 md:py-6">
      <div className="mb-4">
        <h2 className="text-[20px] font-semibold tracking-tight text-ink md:text-[24px]">Veszélyes anyagok</h2>
