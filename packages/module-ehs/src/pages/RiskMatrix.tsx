...
const FALLBACK_LIKELIHOODS: RiskLikelihood[] = [
  'ritka', 'valoszinutlen', 'lehetseges', 'valoszinu', 'szinte_biztos',
]
const FALLBACK_SEVERITIES: RiskSeverity[] = [
  'elhanyagolhato', 'enyhe', 'kozepes', 'sulyos', 'katasztrofalis',
]

const LIKELIHOOD_LIST = RISK_LIKELIHOODS && RISK_LIKELIHOODS.length ? RISK_LIKELIHOODS : FALLBACK_LIKELIHOODS
const SEVERITY_LIST = RISK_SEVERITIES && RISK_SEVERITIES.length ? RISK_SEVERITIES : FALLBACK_SEVERITIES

const DISPLAY_LIKELIHOODS = [...LIKELIHOOD_LIST].reverse()
